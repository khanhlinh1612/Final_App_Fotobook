class AlbumsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @album.save
        format.html { redirect_to user_path(current_user, mode: "albums"), notice: "Album was successfully created." }
  ...
  private
    ...
    def album_params
      params.require(:album).permit(:title,:description,:image,:sharing_status)
    end
end
